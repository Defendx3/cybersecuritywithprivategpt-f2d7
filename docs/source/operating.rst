[cybersecuritywithprivategpt-f2d7] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [cybersecuritywithprivategpt-f2d7] container is NOT running**.

.. tip::
   You must have your [cybersecuritywithprivategpt-f2d7] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Defendx3/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=34249  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Defendx3'  \-\-env DOCKERUSERNAME='defendx'  \-\-env MQTTUSERNAME='dhetkumar123'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   defendx/cybersecuritywithprivategpt-f2d7-amd64 (https://hub.docker.com/r/defendx/cybersecuritywithprivategpt-f2d7-amd64)
...
.. important::
   docker run -d -p 55503:55503 -p 37423:37423 -p 55819:55819 \-\-env TSS=0 \-\-env SOLUTIONNAME=cybersecuritywithprivategpt-f2d7 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-f2d7 \-\-env GITUSERNAME=Defendx3  \-\-env GITREPOURL=https://github.com/Defendx3/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=55503  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=37423  \-\-env SOLUTIONVIPERVIZPORT=55819 \-\-env DOCKERUSERNAME='defendx'  \-\-env EXTERNALPORT=34249 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='dhetkumar123' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  defendx/cybersecuritywithprivategpt-f2d7-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - defendx/cybersecuritywithprivategpt-f2d7-amd64
...
[cybersecuritywithprivategpt-f2d7] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Defendx3/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecuritywithprivategpt-f2d7
...
.. important::
   https://cybersecuritywithprivategpt-f2d7.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-f2d7
...
.. important::
   VIPERHOST_PRODUCE=192.168.5.11, VIPERPORT_PRODUCE=55503, VIPERHOST_PREPOCESS=192.168.5.11, VIPERPORT_PREPROCESS=42013, VIPERHOST_PREPOCESS2=192.168.5.11, VIPERPORT_PREPROCESS2=38981, VIPERHOST_PREPOCESS_PGPT=192.168.5.11, VIPERPORT_PREPROCESS_PGPT=35947, VIPERHOST_ML=192.168.5.11, VIPERPORT_ML=40929, VIPERHOST_PREDCT=192.168.5.11, VIPERPORT_PREDICT=42719, HPDEHOST=192.168.5.11, HPDEPORT=33547, HPDEHOST_PREDICT=192.168.5.11, HPDEPORT_PREDICT=40101

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4817-cybersecuritywithprivategpt-f2d7,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-f2d7, python-preprocess-8549-cybersecuritywithprivategpt-f2d7,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-f2d7, python-ai-5679-cybersecuritywithprivategpt-f2d7,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-f2d7, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
